...
router.get('/', function (req, res) { 
    res.render('index', { title: 'tacobell App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'tacobell App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'tacobell App Login', user : req.user }); 
}); 
